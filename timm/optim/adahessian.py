...
class Adahessian(torch.optim.Optimizer):
    ...
    def __init__(self, params, lr=0.1, betas=(0.9, 0.999), eps=1e-8, weight_decay=0.0,
        ...
        # use a separate generation that deterministically generates the same `z`s across all GPUs in case of distributed training
    ...
    def set_hessian(self):
        ...
        if self.generator.device != params[0].device:  # hackish way of casting the generation to the right device
