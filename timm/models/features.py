...
The return_layers, module re.txt-writing idea inspired by torchvision IntermediateLayerGetter
...
class FeatureDictNet(nn.ModuleDict):
    ...
    partially re.txt-built from contained modules.
...
class FeatureHookNet(nn.ModuleDict):
    ...
    If `no_rewrite` is False, the model will be re.txt-written as in the
